...
export default function SideBar() {
  ...
  return (
    <div className="w-[18%] flex flex-col items-center justify-start h-full border-r-2 border-black ">
      ...
      <div className="w-full mt-4">
        <div className="w-full flex flex-col gap-y-8 h-full mt-2">
          {sideBarData?.map((item: any, id) => (
            <div
              className="flex flex-row  h-[50px] cursor-pointer  hover:bg-gray-200  hover:text-[#1d4ed8] items-center gap-x-4"
              key={id}
